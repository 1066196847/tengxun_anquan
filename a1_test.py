...
def make_train():
    ...
    train = pd.read_csv('../data/test.txt', header=None, sep=' ')
    train.columns = ['id', 'guiji', 'target']
    train_2_col = train[['id', 'guiji']]

    for i in train_2_col['id']:
        print 'a1_1:',i
        ...
        if(i == 1):
            b.to_csv('../data/test_feature/train.csv',index=False,mode='a')
        else:
            b.to_csv('../data/test_feature/train.csv', index=False ,header=None,mode='a')
...
def a1():
    ...
    #
    # new.to_csv('../data/test_feature/new.csv',index=False)

    new = pd.read_csv('../data/test_feature/train.csv')

    '''先计算x的这些'''
    f = open('../data/test_feature/x_10.csv', 'ab')
    writer = csv.writer(f)
    ...
    '''再计算y的这些'''
    f = open('../data/test_feature/y_10.csv', 'ab')
    writer = csv.writer(f)
    writer.writerow(
...
def a2():
    ...
    new = pd.read_csv('../data/test_feature/train.csv')
    '''先计算"速度向量"的这些'''
    f = open('../data/test_feature/x_y_v_10.csv', 'ab')
    writer = csv.writer(f)
    ...
    '''再计算"加速度向量"的这些'''
    f = open('../data/test_feature/x_y_a_10.csv', 'ab')
    writer = csv.writer(f)
...
def a3():
    ...
    # # 3          416,2620,442     1      416     2620      442
    new = pd.read_csv('../data/test_feature/train.csv')
    f = open('../data/test_feature/t_6.csv', 'ab')
    writer = csv.writer(f)
...
def a4():
    ...
    x_10 = pd.read_csv('../data/test_feature/x_10.csv')
    y_10 = pd.read_csv('../data/test_feature/y_10.csv')
    x_y_a_10 = pd.read_csv('../data/test_feature/x_y_a_10.csv')
    x_y_v_10 = pd.read_csv('../data/test_feature/x_y_v_10.csv')
    t_6 = pd.read_csv('../data/test_feature/t_6.csv')
    ...
    new.to_csv('../data/test_feature/train_new_with_label.csv',index=False)
...
def fenxi_1():
    ...
    f = open('../data/test_feature/tongji.csv', 'ab')
    writer = csv.writer(f)
    ...
    f_info = open('../data/test_feature/tongji_info.csv', 'ab')
...
def fenxi_1_add():
    ...
    tongji = pd.read_csv('../data/test_feature/tongji.csv')
