...
'''
def a1():
    new = pd.read_csv('../data/test_feature/train.csv')

    '''先计算x的这些'''
    f = open('../data/test_feature/x_10_add.csv', 'ab')
    writer = csv.writer(f)
    ...
    '''再计算y的这些'''
    f = open('../data/test_feature/y_10_add.csv', 'ab')
    writer = csv.writer(f)
    writer.writerow(
...
def a2():
    ...
    new = pd.read_csv('../data/test_feature/train.csv')
    '''先计算"速度向量"的这些'''
    f = open('../data/test_feature/x_y_v_10_add.csv', 'ab')
    writer = csv.writer(f)
    ...
    '''再计算"加速度向量"的这些'''
    f = open('../data/test_feature/x_y_a_10_add.csv', 'ab')
    writer = csv.writer(f)
...
def a3():
    new = pd.read_csv('../data/test_feature/train.csv')
    f = open('../data/test_feature/t_6_add.csv', 'ab')
    writer = csv.writer(f)
...
def a4():
    ...
    train_new_with_label = pd.read_csv('../data/test_feature/train_new_with_label.csv')
    x_10_add = pd.read_csv('../data/test_feature/x_10_add.csv')
    y_10_add = pd.read_csv('../data/test_feature/y_10_add.csv')
    x_y_a_10_add = pd.read_csv('../data/test_feature/x_y_a_10_add.csv')
    x_y_v_10_add = pd.read_csv('../data/test_feature/x_y_v_10_add.csv')
    t_6_add = pd.read_csv('../data/test_feature/t_6_add.csv')
    ...
    new.to_csv('../data/test_feature/train_new_with_label_with_midian.csv',index=False)
...
def qiang():
    ...
    f = open('../data/test_feature/one_div_five_x_v.csv', 'ab')
    writer = csv.writer(f)
...
def a5():
    ...
    train_new_with_label_with_midian = pd.read_csv('../data/test_feature/train_new_with_label_with_midian.csv')
    one_div_five_x_v = pd.read_csv('../data/test_feature/one_div_five_x_v.csv')
    ...
    new.to_csv('../data/test_feature/train_new_with_label_with_midian_new.csv', index=False)
...
def a6():
    ...
    f = open('../data/test_feature/a6.csv', 'ab')
    writer = csv.writer(f)
...
def a7():
    ...
    f = open('../data/test_feature/a7.csv', 'ab')
    writer = csv.writer(f)
...
def a8():
    ...
    train_new_with_label_with_midian_new = pd.read_csv('../data/test_feature/train_new_with_label_with_midian_new.csv')
    a6 = pd.read_csv('../data/test_feature/a6.csv')
    a7 = pd.read_csv('../data/test_feature/a7.csv')

    new = pd.merge(train_new_with_label_with_midian_new, a6, on='id', how='left')
    new = pd.merge(new, a7, on='id', how='left')

    new.to_csv('../data/test_feature/train_merge_7.csv', index=False)
